...
document.write(`<div class="main"> <h1 class="name">
                  ${simpson.name} 
                  ${simpson.surname} Вік - 
                  ${simpson.age} років</h1>
                    <p class="info"> ${simpson.info}</p>
                    <img class="img" src="${simpson.photo}" alt="simpson_family">
                    </div>`)
...
for (let product of products) {
    document.write(`<div class="product_card"><h3 class="product_title">${product.title} <br>price - ${product.price} $</h3>
    <img class="product_img" src="${product.image}" alt="product"></div>`);
}
