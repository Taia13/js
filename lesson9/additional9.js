...
for (const users of usersList) {
    ...
    div2.innerText= users.id;
    let div3 = document.createElement('div3');
    div3.innerText = users.name;
    let div4 = document.createElement('div4');
    div4.innerText = users.username;
    let div5 = document.createElement('div5');
    div5.innerText = users.email;
    let div6 = document.createElement('div6');
    let p = document.createElement('p');
    p.innerText = users.address.street;
    let p2 = document.createElement('p2');
    p2.innerText = users.address.suite;
    let p3 = document.createElement('p3');
    p3.innerText = users.address.city;
    let p4 = document.createElement('p4');
    p4.innerText = users.address.zipcode;
    let p5 = document.createElement('p5');
    let div7 = document.createElement('div7');
    div7.innerText= users.address.geo.lat;
    let div8 = document.createElement('div8');
    div8.innerText = users.address.geo.lng;
    let div9 = document.createElement('div9');
    div9.innerText = users.phone;
    let div10 = document.createElement('div10');
    div10.innerText = users.website;
    let div11 = document.createElement('div11');
    let p6 = document.createElement('p6');
    p6.innerText = users.company.name;
    let p7 = document.createElement('p7');
    p7.innerText = users.company.catchPhrase;
    let p8 = document.createElement('p8');
    p8.innerText = users.company.bs;

div11.appendChild(p8);
